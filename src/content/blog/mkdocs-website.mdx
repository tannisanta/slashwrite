---
title: "MkDocs site for documentation"
description: "A beginner-friendly guide to creating an MkDocs website using GitHub Pages"
pubDate: 2025-08-03
heroImage: "https://img.freepik.com/premium-photo/minimalist-workspace-with-laptop-cup-coffee-small-plant-symbolizing-productiv_924727-80270.jpg?semt=ais_hybrid&w=740&q=80"
...
In this document, I share the process of building an MkDocs static website and hosting it on GitHub pages.
...
The website is served and can be accessed locally.
![Startpage](https://raw.githubusercontent.com/tannisanta/tt-techcomm-project/main/img/mkdocs_basic.jpg)

If you need to pause and reactivate the environment later, use the following commands in the VS Code terminal of the project:
...
4. In the **workflows** folder, create **ci.yml** file.
...
6. Save changes.
7. Open your GitHub Desktop, add comment and commit changes to GitHub.
...
You can now access your website and share it with others, make changes locally and push them to GitHub. The website is automatically deployed after you push your changes.

My MkDocs website: [TechComm Art](https://tannisanta.github.io/tt-techcomm-project/Static%20websites/MkDocs_website/)
